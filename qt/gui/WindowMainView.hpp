...
namespace cadencii {
    ...
    private slots:
        ...
        void on_tool_action_toggle_line_tool_triggered();
        void on_tool_action_toggle_eraser_tool_triggered();
        void on_menu_action_undo_triggered();
        void on_menu_action_redo_triggered();
        void on_tool_action_undo_triggered();
        void on_tool_action_redo_triggered();
        void on_menu_action_delete_triggered();
