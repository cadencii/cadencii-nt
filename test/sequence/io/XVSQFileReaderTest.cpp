...
TEST(XVSQFileReaderTest, read)
{
    ...
    EXPECT_EQ((size_t)3, sequence.tracks().size());
    ...
    // master
    {
        EXPECT_EQ(0, sequence.master.preMeasure);
        EXPECT_EQ(0, sequence.preMeasure());
    }

    // mixer
    {
        EXPECT_EQ(2, sequence.mixer.masterPanpot);
        EXPECT_EQ(1, sequence.mixer.masterMute);
        EXPECT_EQ(3, sequence.mixer.masterFeder);
        EXPECT_EQ(0, sequence.mixer.outputMode);
        EXPECT_EQ((size_t)3, sequence.mixer.slave.size());
        {
            const MixerItem mixerItem = sequence.mixer.slave[0];
            EXPECT_EQ(0, mixerItem.solo);
            EXPECT_EQ(2, mixerItem.feder);
            EXPECT_EQ(1, mixerItem.mute);
            EXPECT_EQ(5, mixerItem.panpot);
        }
        {
            const MixerItem mixerItem = sequence.mixer.slave[1];
            EXPECT_EQ(1, mixerItem.solo);
            EXPECT_EQ(3, mixerItem.feder);
            EXPECT_EQ(0, mixerItem.mute);
            EXPECT_EQ(6, mixerItem.panpot);
        }
        {
            const MixerItem mixerItem = sequence.mixer.slave[2];
            EXPECT_EQ(0, mixerItem.solo);
            EXPECT_EQ(4, mixerItem.feder);
            EXPECT_EQ(1, mixerItem.mute);
            EXPECT_EQ(7, mixerItem.panpot);
        }
    }

    // 1st track
    {
        Track const& track = sequence.track(0);
        {
            Common const& common = track.common();
            EXPECT_EQ(string("DSB301"), common.version);
            EXPECT_EQ(string("Voice1"), common.name);
            EXPECT_EQ(string("179,181,123"), common.color);
            EXPECT_EQ(vsq::DynamicsMode::EXPERT, common.dynamicsMode);
            EXPECT_EQ(vsq::PlayMode::PLAY_WITH_SYNTH, common.playMode());
            EXPECT_EQ(vsq::PlayMode::PLAY_WITH_SYNTH, common.lastPlayMode());
        }
        EXPECT_EQ(2, track.events().size());
        ...
        // 1st event of 1st track
        {
            ...
            EXPECT_EQ(0, item->vibratoDelay);
            EXPECT_EQ(10, item->pMeanOnsetFirstNote);
            EXPECT_EQ(12, item->vMeanNoteTransition);
            EXPECT_EQ(24, item->d4mean);
            EXPECT_EQ(12, item->pMeanEndingNote);
            EXPECT_EQ((tick_t)0, item->length());
            {
                const Handle *handle = &item->singerHandle;
                EXPECT_EQ(HandleType::SINGER, handle->type());
                EXPECT_EQ(string("hoge"), handle->caption);
                EXPECT_EQ(string("$07010000"), handle->iconId);
                EXPECT_EQ(string("Miku"), handle->ids);
                EXPECT_EQ(0, handle->index);
                EXPECT_EQ((tick_t)1, handle->length());
                EXPECT_EQ(0, handle->original);
                EXPECT_EQ(0, handle->program);
                EXPECT_EQ(0, handle->language);
            }
            {
                const Handle *handle = &item->lyricHandle;
                EXPECT_EQ(HandleType::UNKNOWN, handle->type());
            }
            {
        ...
        // 2nd event of 1st track
        {
            ...
            EXPECT_EQ(72, item->note);
            EXPECT_EQ(64, item->dynamics);
            EXPECT_EQ(8, item->pmBendDepth);
            EXPECT_EQ(0, item->pmBendLength);
            EXPECT_EQ(3, item->pmbPortamentoUse);
            EXPECT_EQ(50, item->demDecGainRate);
            EXPECT_EQ(50, item->demAccent);
            EXPECT_EQ(320, item->vibratoDelay);
            EXPECT_EQ(10, item->pMeanOnsetFirstNote);
            EXPECT_EQ(12, item->vMeanNoteTransition);
            EXPECT_EQ(24, item->d4mean);
            EXPECT_EQ(12, item->pMeanEndingNote);
            EXPECT_EQ((tick_t)960, item->length());
            {
                const Handle *handle = &item->singerHandle;
                EXPECT_EQ(HandleType::UNKNOWN, handle->type());
            }
            {
                ...
                const Lyric lyric = item->lyricHandle.get(0);
                EXPECT_EQ(string("あ"), lyric.phrase);
                EXPECT_EQ(1.0, lyric.lengthRatio);
                EXPECT_EQ(false, lyric.isProtected);
            ...
            }
            {
                ...
                EXPECT_EQ(string("$04040001"), handle->iconId);
                EXPECT_EQ(string(""), handle->ids);
                EXPECT_EQ(1, handle->original);
                EXPECT_EQ(string("[Normal] Type 1"), handle->caption);
                EXPECT_EQ(50, handle->startRate);
                EXPECT_EQ(64, handle->startDepth);
                EXPECT_EQ((tick_t)66, handle->length());
                {
                    const VibratoBPList list = handle->rateBP;
                    EXPECT_EQ(21, list.size());
                    EXPECT_EQ(0.0, list.get(0).x); EXPECT_EQ(104, list.get(0).y);
                    EXPECT_EQ(0.0421875, list.get(1).x); EXPECT_EQ(101, list.get(1).y);
                    EXPECT_EQ(0.0984375, list.get(2).x); EXPECT_EQ(99, list.get(2).y);
                    EXPECT_EQ(0.1453125, list.get(3).x); EXPECT_EQ(97, list.get(3).y);
                    EXPECT_EQ(0.1921875, list.get(4).x); EXPECT_EQ(95, list.get(4).y);
                    EXPECT_EQ(0.2484375, list.get(5).x); EXPECT_EQ(92, list.get(5).y);
                    EXPECT_EQ(0.2953125, list.get(6).x); EXPECT_EQ(89, list.get(6).y);
                    EXPECT_EQ(0.3421875, list.get(7).x); EXPECT_EQ(87, list.get(7).y);
                    EXPECT_EQ(0.3984375, list.get(8).x); EXPECT_EQ(83, list.get(8).y);
                    EXPECT_EQ(0.4453125, list.get(9).x); EXPECT_EQ(80, list.get(9).y);
                    EXPECT_EQ(0.4921875, list.get(10).x); EXPECT_EQ(77, list.get(10).y);
                    EXPECT_EQ(0.5484375, list.get(11).x); EXPECT_EQ(75, list.get(11).y);
                    EXPECT_EQ(0.5953125, list.get(12).x); EXPECT_EQ(73, list.get(12).y);
                    EXPECT_EQ(0.6421875, list.get(13).x); EXPECT_EQ(70, list.get(13).y);
                    EXPECT_EQ(0.6984375, list.get(14).x); EXPECT_EQ(68, list.get(14).y);
                    EXPECT_EQ(0.7453125, list.get(15).x); EXPECT_EQ(65, list.get(15).y);
                    EXPECT_EQ(0.7921875, list.get(16).x); EXPECT_EQ(61, list.get(16).y);
                    EXPECT_EQ(0.8484375, list.get(17).x); EXPECT_EQ(58, list.get(17).y);
                    EXPECT_EQ(0.8953125, list.get(18).x); EXPECT_EQ(55, list.get(18).y);
                    EXPECT_EQ(0.9421875, list.get(19).x); EXPECT_EQ(51, list.get(19).y);
                    EXPECT_EQ(0.9984375, list.get(20).x); EXPECT_EQ(46, list.get(20).y);
                }
                {
                    const VibratoBPList list = handle->depthBP;
                    EXPECT_EQ(21, list.size());
                    EXPECT_EQ(0.0000000, list.get(0).x); EXPECT_EQ(25, list.get(0).y);
                    EXPECT_EQ(0.0421875, list.get(1).x); EXPECT_EQ(27, list.get(1).y);
                    EXPECT_EQ(0.0984375, list.get(2).x); EXPECT_EQ(29, list.get(2).y);
                    EXPECT_EQ(0.1453125, list.get(3).x); EXPECT_EQ(32, list.get(3).y);
                    EXPECT_EQ(0.1921875, list.get(4).x); EXPECT_EQ(34, list.get(4).y);
                    EXPECT_EQ(0.2484375, list.get(5).x); EXPECT_EQ(36, list.get(5).y);
                    EXPECT_EQ(0.2953125, list.get(6).x); EXPECT_EQ(38, list.get(6).y);
                    EXPECT_EQ(0.3421875, list.get(7).x); EXPECT_EQ(41, list.get(7).y);
                    EXPECT_EQ(0.3984375, list.get(8).x); EXPECT_EQ(45, list.get(8).y);
                    EXPECT_EQ(0.4453125, list.get(9).x); EXPECT_EQ(47, list.get(9).y);
                    EXPECT_EQ(0.4921875, list.get(10).x); EXPECT_EQ(50, list.get(10).y);
                    EXPECT_EQ(0.5484375, list.get(11).x); EXPECT_EQ(52, list.get(11).y);
                    EXPECT_EQ(0.5953125, list.get(12).x); EXPECT_EQ(55, list.get(12).y);
                    EXPECT_EQ(0.6421875, list.get(13).x); EXPECT_EQ(58, list.get(13).y);
                    EXPECT_EQ(0.6984375, list.get(14).x); EXPECT_EQ(61, list.get(14).y);
                    EXPECT_EQ(0.7453125, list.get(15).x); EXPECT_EQ(64, list.get(15).y);
                    EXPECT_EQ(0.7921875, list.get(16).x); EXPECT_EQ(68, list.get(16).y);
                    EXPECT_EQ(0.8484375, list.get(17).x); EXPECT_EQ(71, list.get(17).y);
                    EXPECT_EQ(0.8953125, list.get(18).x); EXPECT_EQ(73, list.get(18).y);
                    EXPECT_EQ(0.9421875, list.get(19).x); EXPECT_EQ(76, list.get(19).y);
                    EXPECT_EQ(0.9984375, list.get(20).x); EXPECT_EQ(78, list.get(20).y);
                }
            }
            {
                const Handle *handle = &item->noteHeadHandle;
        ...
        // control curves
        {
            ...
            // dyn
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("dyn"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(45, curve->size());
            ...
            // reso1Freq
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso1freq"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            }
            // reso2Freq
            {
                const BPList *curve = track.curve("reso2freq");
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso2freq"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso3Freq
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso3freq"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso4Freq
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso4freq"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso1bw
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso1bw"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso2bw
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso2bw"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso3bw
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso3bw"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso4bw
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso4bw"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso1amp
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso1amp"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso2amp
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso2amp"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso3amp
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso3amp"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // reso4amp
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("reso4amp"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // harmonics
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("harmonics"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
            ...
            // fx2depth
            {
                ...
                EXPECT_EQ(64, curve->defaultValue());
                EXPECT_EQ(string("fx2depth"), curve->name());
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(0, curve->size());
                EXPECT_EQ(string(""), curve->data());
    ...
    // 2nd track
    {
        Track const& track = sequence.track(1);
        {
            Common const& common = track.common();
            EXPECT_EQ(string("DSB300"), common.version);
            EXPECT_EQ(string("Voice2"), common.name);
            EXPECT_EQ(string("179,181,123"), common.color);
            EXPECT_EQ(vsq::DynamicsMode::STANDARD, common.dynamicsMode);
            EXPECT_EQ(vsq::PlayMode::OFF, common.playMode());
            EXPECT_EQ(vsq::PlayMode::PLAY_AFTER_SYNTH, common.lastPlayMode());
        }
        EXPECT_EQ(2, track.events().size());
        ...
        // 1st event of 2nd track
        {
            ...
            EXPECT_EQ(0, item->dynamics);
            EXPECT_EQ(0, item->pmBendDepth);
            EXPECT_EQ(1, item->pmBendLength);
            EXPECT_EQ(0, item->pmbPortamentoUse);
            EXPECT_EQ(0, item->demDecGainRate);
            EXPECT_EQ(0, item->demAccent);
            EXPECT_EQ(0, item->vibratoDelay);
            EXPECT_EQ(11, item->pMeanOnsetFirstNote);
            EXPECT_EQ(13, item->vMeanNoteTransition);
            EXPECT_EQ(23, item->d4mean);
            EXPECT_EQ(11, item->pMeanEndingNote);
            EXPECT_EQ((tick_t)0, item->length());
            {
                const Handle *handle = &item->singerHandle;
                EXPECT_EQ(HandleType::SINGER, handle->type());
                ...
                EXPECT_EQ(string("$07010000"), handle->iconId);
                EXPECT_EQ(string("Mike"), handle->ids);
                EXPECT_EQ(1, handle->index);
                EXPECT_EQ((tick_t)1, handle->length());
                EXPECT_EQ(1, handle->original);
        ...
        // 2nd event of 2nd track
        {
            const Event *item = track.events().get(1);
            EXPECT_EQ(3, item->id);
            EXPECT_EQ((tick_t)1921, item->tick);
            EXPECT_EQ(EventType::NOTE, item->type());
            EXPECT_EQ(76, item->note);
            EXPECT_EQ(64, item->dynamics);
            EXPECT_EQ(8, item->pmBendDepth);
            EXPECT_EQ(2, item->pmBendLength);
            EXPECT_EQ(3, item->pmbPortamentoUse);
            EXPECT_EQ(50, item->demDecGainRate);
            EXPECT_EQ(50, item->demAccent);
            EXPECT_EQ(320, item->vibratoDelay);
            EXPECT_EQ(12, item->pMeanOnsetFirstNote);
            EXPECT_EQ(14, item->vMeanNoteTransition);
            EXPECT_EQ(22, item->d4mean);
            EXPECT_EQ(10, item->pMeanEndingNote);
            EXPECT_EQ((tick_t)960, item->length());
            {
                const Handle *handle = &item->singerHandle;
                EXPECT_EQ(HandleType::UNKNOWN, handle->type());
            }
            {
                ...
                EXPECT_EQ(2, handle->size());
                {
                    ...
                    EXPECT_EQ(0.5, lyric.lengthRatio);
                    EXPECT_EQ(true, lyric.isProtected);
                    EXPECT_EQ(string("64,0"), lyric.consonantAdjustment());
                    EXPECT_EQ(string("h a"), lyric.phoneticSymbol());
                }
                {
                    const Lyric lyric = item->lyricHandle.get(1);
                    EXPECT_EQ(string("ほ"), lyric.phrase);
                    EXPECT_EQ(0.5, lyric.lengthRatio);
                    EXPECT_EQ(true, lyric.isProtected);
                    EXPECT_EQ(string("64,0"), lyric.consonantAdjustment());
                    EXPECT_EQ(string("h o"), lyric.phoneticSymbol());
                }
            }
            {
                const Handle *handle = &item->vibratoHandle;
    ...
    // 3rd track
    {
        Track const& track = sequence.track(2);
        {
            Common const& common = track.common();
            EXPECT_EQ(string("DSB202"), common.version);
            EXPECT_EQ(string("Voice1"), common.name);
            EXPECT_EQ(string("181,162,123"), common.color);
            EXPECT_EQ(vsq::DynamicsMode::STANDARD, common.dynamicsMode);
            EXPECT_EQ(vsq::PlayMode::PLAY_WITH_SYNTH, common.playMode());
            EXPECT_EQ(vsq::PlayMode::PLAY_WITH_SYNTH, common.lastPlayMode());
        }
        EXPECT_EQ(3, track.events().size());
        // 1st event of 3rd track
        {
            ...
            EXPECT_EQ((tick_t)0, item->length());
            {
                ...
                EXPECT_EQ(string(""), handle->caption);
                EXPECT_EQ(string("$07010000"), handle->iconId);
                EXPECT_EQ(string("MEIKO"), handle->ids);
                EXPECT_EQ(0, handle->index);
                EXPECT_EQ((tick_t)1, handle->length());
                EXPECT_EQ(0, handle->original);
                EXPECT_EQ(0, handle->program);
        ...
        // 2nd event of 3rd track
        {
            ...
            EXPECT_EQ((tick_t)1920, item->tick);
            EXPECT_EQ(EventType::NOTE, item->type());
            EXPECT_EQ(63, item->note);
            EXPECT_EQ(72, item->dynamics);
            EXPECT_EQ(8, item->pmBendDepth);
            EXPECT_EQ(0, item->pmBendLength);
            EXPECT_EQ(0, item->pmbPortamentoUse);
            EXPECT_EQ(50, item->demDecGainRate);
            EXPECT_EQ(50, item->demAccent);
            EXPECT_EQ(960, item->vibratoDelay);
            EXPECT_EQ(10, item->pMeanOnsetFirstNote);
            EXPECT_EQ(12, item->vMeanNoteTransition);
            EXPECT_EQ(24, item->d4mean);
            EXPECT_EQ(12, item->pMeanEndingNote);
            ...
            }
            {
                ...
                {
                    const Lyric lyric = item->lyricHandle.get(0);
                    EXPECT_EQ(string("a"), lyric.phrase);
                    EXPECT_EQ(1.0, lyric.lengthRatio);
                    EXPECT_EQ(false, lyric.isProtected);
                    EXPECT_EQ(string("0"), lyric.consonantAdjustment());
                    EXPECT_EQ(string("a"), lyric.phoneticSymbol());
            ...
            }
            {
                ...
                EXPECT_EQ(string("$01010008"), handle->iconId);
                EXPECT_EQ(string("trill_whole"), handle->ids);
                EXPECT_EQ(8, handle->original);
                EXPECT_EQ(64, handle->depth);
                EXPECT_EQ(64, handle->duration);
                EXPECT_EQ(string("Trill Wholetone"), handle->caption);
        ...
        // 3rd event of 3rd track
        {
            ...
            EXPECT_EQ(3, item->id);
            EXPECT_EQ((tick_t)3360, item->tick);
            EXPECT_EQ(EventType::ICON, item->type());
            EXPECT_EQ(68, item->note);
            EXPECT_EQ(64, item->dynamics);
            EXPECT_EQ(8, item->pmBendDepth);
            EXPECT_EQ(0, item->pmBendLength);
            EXPECT_EQ(0, item->pmbPortamentoUse);
            ...
            }
            {
                ...
                EXPECT_EQ(string("$05020005"), handle->iconId);
                EXPECT_EQ(string("cresc_5"), handle->ids);
                EXPECT_EQ(5, handle->original);
                EXPECT_EQ(string("Zero Crescendo Curve"), handle->caption);
                EXPECT_EQ((tick_t)480, handle->length());
                EXPECT_EQ(0, handle->startDyn);
                EXPECT_EQ(102, handle->endDyn);
                EXPECT_EQ(1, handle->dynBP.size());
                EXPECT_EQ(0.5, handle->dynBP.get(0).x);
                EXPECT_EQ(40, handle->dynBP.get(0).y);
            }
        }
        ...
        // control curves
        {
            ...
            // reso1Freq
            {
                ...
                EXPECT_EQ(127, curve->maximum());
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2000=1"), curve->data());
            }
            // reso2Freq
            {
                const BPList *curve = track.curve("reso2freq");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2001=2"), curve->data());
            }
            // reso3Freq
            {
                const BPList *curve = track.curve("reso3freq");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2002=3"), curve->data());
            }
            // reso4Freq
            {
                const BPList *curve = track.curve("reso4freq");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2003=4"), curve->data());
            }
            // reso1bw
            {
                const BPList *curve = track.curve("reso1bw");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2004=5"), curve->data());
            }
            // reso2bw
            {
                const BPList *curve = track.curve("reso2bw");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2006=7"), curve->data());
            }
            // reso3bw
            {
                const BPList *curve = track.curve("reso3bw");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2007=8"), curve->data());
            }
            // reso4bw
            {
                const BPList *curve = track.curve("reso4bw");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2008=9"), curve->data());
            }
            // reso1amp
            {
                const BPList *curve = track.curve("reso1amp");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2009=10"), curve->data());
            }
            // reso2amp
            {
                const BPList *curve = track.curve("reso2amp");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2010=11"), curve->data());
            }
            // reso3amp
            {
                const BPList *curve = track.curve("reso3amp");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2011=12"), curve->data());
            }
            // reso4amp
            {
                const BPList *curve = track.curve("reso4amp");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2012=13"), curve->data());
            }
            // harmonics
            {
                const BPList *curve = track.curve("harmonics");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2013=14"), curve->data());
            }
            // fx2depth
            {
                const BPList *curve = track.curve("fx2depth");
                ...
                EXPECT_EQ(0, curve->minimum());
                EXPECT_EQ(1, curve->size());
                EXPECT_EQ(string("2014=15"), curve->data());
            }
        }
    }
}

TEST(XVSQFileReaderTest, readWithException)
{
    XVSQFileReader reader;
    SAXAdapterStub adapter("");
    Sequence sequence;
    EXPECT_THROW(reader.read(&sequence, &adapter), XVSQFileReader::ParseException);
}
